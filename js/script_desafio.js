...
function solicitarCantidad() {
    var cantidad = parseInt(prompt("Ingrese la cantidad de unidades del producto anterior"))
    if (isNaN(cantidad)) {
...
while (entrada) {
    let prod = solicitarProducto();
    console.log(prod);
    let cant = solicitarCantidad();
    console.log(cant);
    let costo = calcularCosto(cant, productos[prod - 1]);
